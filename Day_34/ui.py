...
class QuizInterface:
    ...
    def __init__(self, quiz_brain:QuizBrain):
        ...
        self.quiz_question = self.canvas.create_text(150,125, width=260, text="working", font=("Arial", 15, "italic"), fill=THEME_COLOR)
        self.canvas.grid(row=1, column=0, columnspan=2,padx=5,pady=5)

        self.true_img = PhotoImage(file="./day_34/images/true.png")
        self.true_button = Button(image=self.true_img, highlightthickness=0, command=self.true_clicked)
        self.true_button.grid(row=2, column=0)

        self.false_img = PhotoImage(file="./day_34/images/false.png")
    ...
    def get_next_question(self):
        ...
        if self.quiz.still_has_questions():
            ...
            self.canvas.itemconfig(self.quiz_question, text="You have reached end of the question.")
